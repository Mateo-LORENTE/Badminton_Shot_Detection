...
from TrackNetV3_old.test import predict_location, get_ensemble_weight, generate_inpaint_mask
from TrackNetV3_old.dataset import Shuttlecock_Trajectory_Dataset
from TrackNetV3_old.utils.general import *
...
if __name__ == '__main__':
    ...
    for video in videos :
        ...
        frame_list, fps, (w, h) = generate_frames(video)
